...
class ColorSchemePreview extends StatefulWidget {
  const ColorSchemePreview({super.key});

  @override
  State<ColorSchemePreview> createState() => _ColorSchemePreviewState();
}

class _ColorSchemePreviewState extends State<ColorSchemePreview> {
  Color selectedColor = ColorSeed.baseColor.color;
  Brightness selectedBrightness = Brightness.light;
  double selectedContrast = 0;
              ...
              Wrap(
                ...
                children: <Widget>[
                  ...
                  ...List<Widget>.generate(
                    ...
                    (int index) {
                      final itemColor = ColorSeed.values[index].color;
                      return IconButton(
